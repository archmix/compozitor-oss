...
public class TypeParameterModel extends TypeModel {
  ...
  TypeParameterModel(ProcessingEnvironment environment, TypeParameterElement element,
    ...
    super(environment, (TypeElement) element.getEnclosingElement(), packageModel, annotations,
